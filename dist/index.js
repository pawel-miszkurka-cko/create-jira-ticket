...
const createTicketPayload = ({ projectKey, activeSprintField, activeSprintId, summary, description }) => {
    const issue = {
        fields: {
            project: {
                key: projectKey
...
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
const createJiraApiInstance = (host, token) => {
    ...
    const getActiveSprint = (boardId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const response = yield get(`${host}/rest/agile/1.0/board/${boardId}/sprint?state=active`);
